...
var ArkimeOptions struct {
	...
	ReqBodyOnlyUtf8     string `long:"config.reqBodyOnlyUtf8" ini-name:"config.reqBodyOnlyUtf8" ini-default:"true"     env:"ARKIME_CONFIG.REQBODYONLYUTF8" default:"true"                                                                             description:"Only store request bodies that Utf-8?"                                                                                                                                                                                                                                                                                                                                                                                                                                                choice:"true" choice:"false"`
	...
	LogUnknownProtocols string `long:"logUnknownProtocols"    ini-name:"logUnknownProtocols"    ini-default:"true"     env:"ARKIME_LOGUNKNOWNPROTOCOLS"    default:"false"                                                                            description:"DEBUG - Write to stdout unknown protocols"                                                                                                                                                                                                                                                                                                                                                                                                                                            choice:"true" choice:"false"`
	LogESRequests       string `long:"logESRequests"          ini-name:"logESRequests"          ini-default:"true"     env:"ARKIME_LOGESREQUESTS"          default:"true"                                                                             description:"DEBUG - Write to stdout elastic search requests"                                                                                                                                                                                                                                                                                                                                                                                                                                      choice:"true" choice:"false"`
	LogFileCreation     string `long:"logFileCreation"        ini-name:"logFileCreation"        ini-default:"true"     env:"ARKIME_LOGFILECREATION"        default:"true"                                                                             description:"DEBUG - Write to stdout file creation information"                                                                                                                                                                                                                                                                                                                                                                                                                                    choice:"true" choice:"false"`
}
...
var GeneralOptions struct {
	...
	Rpcap                  string         `long:"rpcap"                  no-ini:"true" ini-default:"false"    env:"ARKIME_RPCAP"                                                                                                       description:"Enable Capture on FIFO-Pipe where tcpdump sends packages from rpcap interface"`
